...
This project aims to analyze educational disparities in Massachusetts school districts, specifically focusing on computer science education and AP test participation among African American/Black, Hispanic/Latino, and indigenous communities compared to other ethnic groups. By conducting research and data analysis, we seek to identify the factors contributing to these disparities and provide actionable recommendations for promoting equitable educational opportunities in MA.
...
* Checked for multiple potential correlations for every ethnic group district-wise, such as ap scores, passing %, various education level types, etc. 
* Identify correlations between the count of NGOs operating in the education space vs. ap scores/passing % in different districts for low-income students and others. 
...
- Priyank/
    - Jupyter notebooks, files & Data related to Priyank's work
- Vincent_Code/
    - Files and data related to Vincent's analysis
- laya_csMassLiteracy_R/
    - R Markdown file and associated files for Laya's work

```

# How to Run

Open the ipynb notebooks or Rmd files provided by each collaborator to run their analysis.
...
* Utilize this project as a baseline and dive deeper by utilizing Census data and asking better and more interesting questions
* Collect more diverse data to explore other potential determining factors concerning CS education. Also, study the correlations with the time series element. 
* Explore county-wise correlations or hone down on a specific county of interest and dig deeper to find better correlations. 
* Examining the impact of NGOs operating in the STEM space on improving computer science (CS) literacy across diverse ethnicities and districts in Massachusetts (MA)
